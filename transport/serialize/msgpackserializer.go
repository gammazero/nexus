...
//
// If InitMsgpackHandle is called to re-initialize the handle, call
// MsgpackRegisterExtension after InitMsgpackHandle to re-register any
// extensions, since InitMsgpackHandle discards all previously registered
// extensions.
